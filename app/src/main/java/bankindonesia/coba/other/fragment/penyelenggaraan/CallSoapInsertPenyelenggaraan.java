...
public class CallSoapInsertPenyelenggaraan
{
    public final String SOAP_ACTION = "http://tempuri.org/InsertRencanaPenyelenggaraan";
    public  final String OPERATION_NAME = "InsertRencanaPenyelenggaraan";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapInsertPenyelenggaraan()
    {
    }
