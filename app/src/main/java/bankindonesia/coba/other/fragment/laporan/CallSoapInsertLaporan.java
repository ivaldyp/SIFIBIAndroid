...
public class CallSoapInsertLaporan
{
    public final String SOAP_ACTION = "http://tempuri.org/InsertHasilSidang";
    public  final String OPERATION_NAME = "InsertHasilSidang";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapInsertLaporan()
    {
    }
                       ...
                       String editTextSatker,String jadwal,String lembagalain)
    {
        ...
        PropertyInfo pi21=new PropertyInfo();pi21.setName("id_users");              pi21.setValue(a);pi21.setType(Integer.class);request.addProperty(pi21);
