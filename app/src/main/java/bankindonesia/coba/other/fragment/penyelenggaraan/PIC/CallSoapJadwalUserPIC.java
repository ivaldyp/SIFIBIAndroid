...
{
    public final String SOAP_ACTION = "http://tempuri.org/SelectIDNamaTanggalPenyelenggaraan";
    public  final String OPERATION_NAME = "SelectIDNamaTanggalPenyelenggaraan";
