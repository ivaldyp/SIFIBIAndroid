...
public class CallSoapViewDetailLaporan {
    public final String SOAP_ACTION = "http://tempuri.org/SelectHasilSidangByID";
    public  final String OPERATION_NAME = "SelectHasilSidangByID";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapViewDetailLaporan()
    {
    }
