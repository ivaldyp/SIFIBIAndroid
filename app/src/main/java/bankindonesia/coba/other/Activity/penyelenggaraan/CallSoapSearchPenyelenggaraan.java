...
public class CallSoapSearchPenyelenggaraan
{
    public final String SOAP_ACTION = "http://tempuri.org/SearchPenyelenggaraan";
    public  final String OPERATION_NAME = "SearchPenyelenggaraan";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapSearchPenyelenggaraan()
    {
    }
