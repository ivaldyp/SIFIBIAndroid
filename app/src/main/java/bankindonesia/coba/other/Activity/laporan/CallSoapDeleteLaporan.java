...
public class CallSoapDeleteLaporan
{
    public final String SOAP_ACTION = "http://tempuri.org/DeleteHasilSidang";
    public  final String OPERATION_NAME = "DeleteHasilSidang";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapDeleteLaporan()
    {
    }
