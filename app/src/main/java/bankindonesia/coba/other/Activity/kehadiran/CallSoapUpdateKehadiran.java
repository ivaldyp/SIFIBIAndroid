...
public class CallSoapUpdateKehadiran
{
    public final String SOAP_ACTION = "http://tempuri.org/UpdateRencanaKehadiran";
    public  final String OPERATION_NAME = "UpdateRencanaKehadiran";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapUpdateKehadiran()
    {
    }
    ...
    public String Call(int a, String b, String c, String d, String e, String f, String g, String h, String i)
    {
        ...
        PropertyInfo pi=new PropertyInfo();pi.setName("id_kehadiran");pi.setValue(a);pi.setType(Integer.class);request.addProperty(pi);
