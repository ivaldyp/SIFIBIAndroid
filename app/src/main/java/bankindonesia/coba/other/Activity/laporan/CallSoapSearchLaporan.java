...
public class CallSoapSearchLaporan
{
    public final String SOAP_ACTION = "http://tempuri.org/SearchSidang";
    public  final String OPERATION_NAME = "SearchSidang";
    public  final String WSDL_TARGET_NAMESPACE = "http://tempuri.org/";
    public  final String SOAP_ADDRESS = Config.LOGIN_ASP;

    public CallSoapSearchLaporan()
    {
    }
