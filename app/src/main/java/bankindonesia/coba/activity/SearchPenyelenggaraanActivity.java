...
import bankindonesia.coba.other.Activity.penyelenggaraan.CallerSearchPenyelenggaraan;
import bankindonesia.coba.other.Config;
import bankindonesia.coba.other.fragment.penyelenggaraan.CallerJadwalDetailUser;

public class SearchPenyelenggaraanActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_penyelenggaraan);
    ...
    private void search() {
        ...
        {
            rslt="START";
            CallerSearchPenyelenggaraan c=new CallerSearchPenyelenggaraan();
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if(((Config) getApplication()).getID_JABATAN()==1){
                            ...
                            ((Config) getApplication()).setID_PENYELENGGARAAN(id_penyelenggaraan);
                            Intent intent = new Intent(getApplicationContext(), JadwalDetailPenyelenggaraanActivity.class);
...
//                                Toast.makeText(getApplicationContext(),"Berhasil", Toast.LENGTH_LONG).show();
                                ...
                                Intent intent = new Intent(getApplicationContext(), JadwalDetailPenyelenggaraan2Activity.class);
