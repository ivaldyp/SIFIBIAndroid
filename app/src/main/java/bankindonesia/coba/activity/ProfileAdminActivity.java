//Code untuk menampilkan profile activity dari admin
...
public class ProfileAdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        });
        ...
        ft.replace(R.id.mainFrame, new HomeAdminFragment());
        ft.commit();
    }
...
//        DialogFragment dialogFragment;
        if (id == R.id.nav_home) {
          ...
          else if (id == R.id.nav_userbelumterverif) {
            fragment = new UserNotVerifFragment();
        } else if (id == R.id.nav_usersudahterverif) {
            fragment = new UserVerifFragment();
        }
          else if (id == R.id.nav_insertkehadiran) {
            fragment = new InsertKehadiranFragment();
        } else if (id == R.id.nav_jadwalkehadiran) {
        ...
        } else if (id == R.id.nav_jadwalpenyelenggaraan) {
        ...
        } else if (id == R.id.nav_tabellaporan) {
