//Code untuk menampilkan page detail kehadiran tanpa verifikasi
...
import bankindonesia.coba.other.Activity.kehadiran.CallerDeleteKehadiran;
import bankindonesia.coba.other.Config;
import bankindonesia.coba.other.fragment.kehadiran.CallerJadwalDetailUser;

public class JadwalDetailKehadiranActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_detail_kehadiran);
        data();
...
//        ad.show();
    ...
    private void delete() {
        ...
        {
            rslt="START";
            CallerDeleteKehadiran c=new CallerDeleteKehadiran();
            c.a=((Config) this.getApplication()).getID_KEHADIRAN();
//            c.ad=ad;
            c.join(); c.start();
            while(rslt=="START") {
...
//        ad.show();
    ...
    public void onClick(View v) {
        if(v == buttonUpdate) {
            Intent intent = new Intent(this, UpdateKehadiranActivity.class);
//            startActivity(intent);
