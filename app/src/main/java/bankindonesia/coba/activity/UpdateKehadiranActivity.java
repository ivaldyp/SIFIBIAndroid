...
import bankindonesia.coba.other.Activity.kehadiran.CallerUpdateKehadiran;
import bankindonesia.coba.other.Config;
import bankindonesia.coba.other.fragment.kehadiran.CallerJadwalDetailUser;

public class UpdateKehadiranActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_kehadiran);
...
//        ad.show();
    ...
    private void update() {
        ...
        {
            rslt="START";
            CallerUpdateKehadiran c=new CallerUpdateKehadiran();
            c.a=((Config) this.getApplication()).getID_KEHADIRAN();
