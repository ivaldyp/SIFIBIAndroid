...
import bankindonesia.coba.other.Activity.user.CallerNotVerifikasiUser;
...
public class UserDetailActivity2 extends AppCompatActivity implements View.OnClickListener{
...
//        ad.show();
    ...
    private void notfix() {
        ...
        {
            rslt="START";
            CallerNotVerifikasiUser c=new CallerNotVerifikasiUser();
            c.a=((Config) this.getApplication()).getID_USERPILIHAN();
//            c.ad=ad;
            c.join(); c.start();
            while(rslt=="START") {
            ...
            if(rslt.equals("1")){
                Toast.makeText(getApplicationContext(),"User BERHASIL di non-aktifkan", Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(getApplicationContext(),"User GAGAL di non-aktifkan", Toast.LENGTH_LONG).show();
            }
//            ad.setTitle("TES");
//            ad.setMessage(linesCsv[2][3]);
...
//        ad.show();
    ...
    public void onClick(View v) {
        if(v == buttonUpdate) {
            ...
            builder.setMessage("Dengan MENONAKTIFKAN USER anda akan membuat user tersebut menjadi BELUM TERVERIFIKASI KEMBALI")
                    .setCancelable(true)
