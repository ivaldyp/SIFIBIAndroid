...
import bankindonesia.coba.other.fragment.home.CallerHomeAdmin;
...
//        return inflater.inflate(R.layout.fragment_home_pic, container, false);
        ...
        countUser = (TextView) view.findViewById(R.id.countUser);
        ...
        countUser.setText(array[4]);
        countLaporan.setText(array[5]);
    ...
    private void data() {
        ...
        {
            rslt="START";
            CallerHomeAdmin c=new CallerHomeAdmin();
