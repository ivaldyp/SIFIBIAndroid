...
import bankindonesia.coba.other.fragment.home.CallerHomePJ;

/**
 * A simple {@link Fragment} subclass.
 */
public class HomePJFragment extends Fragment {
...
//        return inflater.inflate(R.layout.fragment_home_pic, container, false);
        View view = inflater.inflate(R.layout.fragment_home_pj, container, false);
    ...
    private void data() {
        ...
        {
            rslt="START";
            CallerHomePJ c=new CallerHomePJ();
