...
import bankindonesia.coba.other.fragment.kehadiran.CallerInsertKehadiran;

/**
 * A simple {@link Fragment} subclass.
 */
public class InsertKehadiranFragment extends Fragment implements View.OnClickListener{
    ...
    public static InsertKehadiranFragment newInstance() {return new InsertKehadiranFragment();}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment

        View view = inflater.inflate(R.layout.fragment_insert_kehadiran, container, false);
...
//        spinnerSatker2.setAdapter(dataAdapter2);
    }
    ...
    private void userRegister() {
        ...
        {
            rslt="START";
            CallerInsertKehadiran c=new CallerInsertKehadiran();
...
//        ad.show();
    ...
    public void onClick(View v) {
        ...
        if(v == buttonRegister) {
//            if(editTextPeriode.getText().toString().compareTo("")==0 ||editTextName.getText().toString().compareTo("")==0 ||editTextPlace.getText().toString().compareTo("")==0 ||text.getText().toString().compareTo("Klik di sini")==0 ||delegasiADG.getText().toString().compareTo("")==0 ||editTextSatker.getText().toString().compareTo("")==0 ||topikEvent.getText().toString().compareTo("")==0)
//                Toast.makeText(getActivity().getApplicationContext(),"Semua data harus diisikan", Toast.LENGTH_LONG).show();
//            else {
                userRegister();
                getFragmentManager().beginTransaction().replace(R.id.mainFrame, InsertKehadiranFragment.newInstance()).commit();
//            }
        }
    }
